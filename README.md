- 👋 我是泇吟🎶，一位前端工程師，也是一位喜歡觀察使用者行為的設計思維實踐者。
- 🌱 專注前端語言，具備兩年以上 Vue.js / React.js 前端開發經驗，擅長做出貼合設計師和使用者需求的網站。
  - 能獨立完成從網頁切版到 API 串接的功能整合專案。
  - 擅長以模組化架構與清晰視覺邏輯，打造具有互動性與使用者溝通感的網頁產品。
  - 曾任線上課程平台前端專題教練，擅長溝通協作與技術解釋，亦有多篇開發筆記與教學影片紀錄。
